...
poimenujemo kar osrčje programa za avtomatizirano izdelavo  % razdelek
...
zato si je smiselno podrobneje ogledati posamezne korake.
   ...
   \begin{enumerate}
      ...
      \(j\)-tem koraku označimo spredmet\(_j\)?.
   
      \item Za vse proste termine predavalnice\(_j\) izračunamo ceno vstavljanja
      ...
      \item Ko preverimo vse proste termine vseh predavalnic, vstavimo srečanja\(_i\)
...
\end{verbatim}
   ...
   \begin{enumerate}
      \item Vprvem koraku izvedemo požrešno metodo, ki rešitev urnika pripelje v lokalni maksimum.
...
gostom za mizo. S tem imamo v mislih grafični uporabniški vmesnik (\underbar{G}raphical
\underbar{U}ser \underbar{I}nterface), ki mora urnik uporabnikom predstaviti na razumljiv in
